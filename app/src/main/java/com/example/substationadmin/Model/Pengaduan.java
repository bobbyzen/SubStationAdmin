package com.example.substationadmin.Model;
...
public class Pengaduan implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeString(gardu_id);
        dest.writeString(id);
        dest.writeString(laporan);
        dest.writeString(status_baru);
        dest.writeString(status_lama);
        dest.writeString(tanggal_baru);
        dest.writeString(tanggal_lama);
